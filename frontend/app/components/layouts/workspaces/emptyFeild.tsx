...
export const EmptyFeild = ({title, description, buttonAction, buttonText, className} : PropsType) =>{
    ...
    return (
        <div className="col-span-full text-center py-12 2xl:py-24">
            ...
            <h3 className="mt-4 text-lg font-semibold text-main-font">{title}</h3>
            <p className="mt-2 text-sm text-muted-foreground max-w-sm text-pretty mx-auto">
                {description}
            </p>

            <Button onClick={buttonAction} className={cn("mt-4", className)}>
