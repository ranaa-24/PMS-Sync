...
function MyTasks() {
    ...
    if (!myTasks && !isLoading) return <div className='h-full flex items-center justify-center text-secondary-font'>
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-start md:items-center justify-between">
                ...
                >
                    <Button
                        className="bg-theme-primary hover:bg-theme-primary hover:brightness-125 text-main-font mr-3"
                        variant={"ghost"}
                        onClick={() =>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant={"ghost"} className="bg-theme-secondary hover:bg-theme-secondary hover:brightness-125 text-main-font">
                                <FilterIcon className="w-4 h-4" /> Filter
                            </Button>
                        </DropdownMenuTrigger>

                        <DropdownMenuContent className="bg-deep-surface text-main-font border border-main-border">
                        ...
                        <Card className="bg-surface border-main-border text-main-font">
                            ...
                            <CardContent className="p-3 space-y-3 max-h-[600px] overflow-y-auto ">
                                {todoTasks?.map((task) => (
                                    <Card
                                        key={task._id}
                                        className="hover:shadow-md transition-shadow bg-surface border-main-border text-main-font px-3"
                                    >
                                        <Link
                                            to={`/workspaces/${task.project.workspace}/projects/${task.project._id}/tasks/${task._id}`}
                                            className="block"
